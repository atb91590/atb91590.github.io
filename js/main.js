...
var mySkills = {
	statements:[
		...
		'Familiar with Bayesian Classification & NP-Complete Problems'
	],
	libraries:[
...
var myJobs = [
	{
		...
		logo:'http://bss.lacity.org/img/bss_logo_transparent.png',
		...
		endDate:'Present',
		duties:[
			'Sole developer of Front & Back End intranet applications for financial management division',
			'Worked with a team of interns to extend upon the LABSS android application'
		]
	},
	{
		title:'Technology College Aide',
		logo:'http://vector.me/files/images/1/2/12121/lbusd.png',
...
var myProjects = [
	{
		...
		stack:{
			...
			frontend:'HTML, CSS, Javascript (AngularJS, IonicFramework, jQuery Mobile)'
		},
	...
	{
		title:'Los Angeles Bureau of Street Services (LABSS) Android Application',
		type:'Internship',
		stack:{
	...
	},
	{
		...
		description:'A simple 2D scroller game where the player must survive until the timer runs out.',
		images:[
	...
	{
		title:'Various LA Fiscal Systems Intranet Web Applications',
		type:'Internship',
		stack:{
